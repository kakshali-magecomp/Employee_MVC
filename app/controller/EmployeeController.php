...
class EmployeeController
{
    ...
    public function login(): void
    {
        ...
        $employeeLoginModel = new LoginActivityModel();
        // $employee = $employeeLoginModel ->getemployeeById($id);
        // $login = $employeeLoginModel->storeLogin($employeeId, $ipAddress, $deviceInfo);
        ...
        if ($user['role'] === 'admin')
        {
            ...
            $employeeId = $user['id']; // use this directly
