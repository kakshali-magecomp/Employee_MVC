...
<nav class="bg-indigo-700 ">
    <div class="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
        ...
        <div class="flex gap-4">
            <a href="index.php?page=attendance"class="bg-white text-indigo-700 px-5 py-3 rounded-xl font-semibold hover:bg-gray-200 transition">
                Attendance Panel 
            </a>
            <a href="index.php?page=logout" class="bg-red-500 text-white px-5 py-3 rounded-xl font-semibold hover:bg-red-600 transition">
                Logout
            </a>
        </div>
    </div>
                        ...
                        <?php foreach($attendanceRecords as $row): ?>
                            <tr class="border-b hover:bg-gray-50 transition">
                                ...
                                <td class="p-5 flex gap-3">
                                    <a href="index.php?page=editattendance&id=<?= $row['id'] ?>" class="bg-yellow-400 hover:bg-yellow-500 text-white px-4 py-2 rounded-xl text-sm font-semibold transition">
                                        Edit
                                    </a>

                                    <a href="index.php?page=deleteattendance&id=<?= $row['id'] ?>" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-xl text-sm font-semibold transition" onclick="return confirm('Delete Attendance Record?')">
                                        Delete
                                    </a>
                                </td>
                            </tr>
